...
DataProvider::Status DataProvider::Read(std::array<int16_t, DataProvider::BUFFERDEPTH>& data)
{
  size_t bytesRead = 0;
  esp_err_t result_I2S0 = i2s_read(I2S_PORT_ONE, data, sizeof(int16_t) * BUFFERDEPTH,
