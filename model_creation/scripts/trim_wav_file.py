...
# Open the .wav file
with wave.open("no_rain.wav", "rb") as wav_file:
    ...
    for i in range(num_chunks):
        ...
        with wave.open(f"/home/nikolas/git/bachelorthesis/model_creation/train_data/no_rain/chunk_{i+1}.wav", "wb") as chunk_file:
