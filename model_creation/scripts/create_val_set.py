...
#     num_test_files = int(_percentage * len(files))

#     # Randomly select the files to move to the test set
#     test_files = random.sample(files, num_validation_files)

#     # Move the selected validation files to the validation_data or test_data folder
